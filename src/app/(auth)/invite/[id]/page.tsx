...
export default function InvitePage() {
  ...
  return (
    <div className="min-h-screen bg-clean-canvas dark:bg-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-2xl shadow-xl overflow-hidden border border-slate-100 dark:border-slate-800">
        <div className="bg-strategic-teal p-8 text-center relative overflow-hidden">
        ...
        <div className="p-8 text-center">
          {error ? (
            ...
            <>
              <div className="mb-8">
                <p className="text-logic-slate dark:text-slate-400 text-sm mb-2">以下のプロジェクトに招待されています</p>
                <div className="flex items-center justify-center gap-2 text-xl font-black text-oxford-navy dark:text-slate-200">
              ...
              {!user ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-strategic-teal hover:bg-strategic-teal text-white py-3 rounded-xl font-bold transition-colors shadow-lg shadow-primary-600/30 disabled:opacity-50"
                >
