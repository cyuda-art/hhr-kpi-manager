      ...
      <div className="max-w-md w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/50 dark:border-slate-800/50 relative z-10">
        ...
        <div className="p-8 text-center">
          {error ? (
            ...
            <>
              <div className="mb-8">
                <div className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary-50 dark:bg-primary-900/30 rounded-xl text-xl font-black text-primary-700 dark:text-primary-300 border border-primary-100 dark:border-primary-800/50">
                  {orgName || '読み込み中...'}
                </div>
              </div>
              ...
              {!user ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-primary-600/30 disabled:opacity-50"
                >
