...
export default function DashboardRedirect() {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-clean-canvas dark:bg-[#050505]">
      <div className="animate-pulse flex flex-col items-center">
        <div className="w-8 h-8 border-4 border-strategic-teal border-t-transparent rounded-full animate-spin"></div>
        <p className="mt-4 text-sm font-mono text-slate-500 tracking-widest uppercase">Authenticating...</p>
      </div>
    </div>
  );
}
